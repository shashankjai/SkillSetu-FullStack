...
const SessionSchedulingModal = ({
  ...
  return (
    <div className="modal-overlay fixed top-0 left-0 w-full h-full bg-gray-500 bg-opacity-50 flex justify-center items-center px-4 py-6">
